        ...
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm font-medium">
                    ...
                    @auth
                        <li><a href="{{ route('admin.index') }}" class="hover:text-white transition-colors">Painel Administrativo</a></li>
                    @endauth
                    <li><a href="#" class="hover:text-white transition-colors">FAQ / Ajuda</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="space-y-4 text-sm">
                    ...
                    <p class="flex items-center gap-2">📞 +55 (81) 99999-9999</p>
                </div>
            </div>
        </div>
        <div class="container mx-auto px-6 mt-16 pt-8 border-t border-gray-800/50 text-center text-xs">
            <p>&copy; {{ date('Y') }} <strong>Simplemind</strong>. Todos os direitos reservados.</p>
        </div>
    </footer>

    <div class="fixed bottom-6 left-6 z-50">
        <a href="https://wa.me/5581999999999?text=Olá,%20preciso%20de%20ajuda%20com%20a%20Simplemind" 
            target="_blank" class="bg-[#25D366] hover:bg-[#20ba5a] text-white p-4 rounded-full shadow-lg transition-all transform hover:scale-110 flex items-center justify-center">
