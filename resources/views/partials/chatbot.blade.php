...
<div class="fixed bottom-6 left-6 z-50">
    <a href="https://wa.me/558182350502?text=Olá,%20preciso%20de%20ajuda%20com%20a%20Simplemind" 
       target="_blank" 
       class="bg-[#25D366] hover:bg-[#20ba5a] text-white p-4 rounded-full shadow-lg transition-all transform hover:scale-110 flex items-center justify-center border-2 border-white/20 active:scale-95 shadow-green-200">
...
<div class="fixed bottom-6 right-6 z-50">
    <button onclick="toggleChat()" 
            class="bg-blue-600 hover:bg-blue-700 text-white p-4 rounded-full shadow-lg transition-all transform hover:scale-110 flex items-center justify-center border-2 border-white/20 active:scale-95 shadow-blue-200">
